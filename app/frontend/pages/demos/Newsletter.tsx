...
const Newsletter: FCWithLayout = () => {
  return (
    <div className="flex flex-col justify-center relative isolate overflow-hidden min-h-[55dvh] bg-gray-900 py-16 sm:py-24 lg:py-32">
      ...
      <div
        aria-hidden="true"
        className="absolute min-h-[55dvh] left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6"
      >
        <div
          style={{
            clipPath:
