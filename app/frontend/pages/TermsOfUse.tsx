    ...
    <div className="py-10">
      <div className="flex min-h-[var(--lc-min-hero-height)] leading-loose flex-col justify-center max-w-7xl mx-auto sm:px-6 py-12 lg:px-8">
        ...
        <p>
          ...
          <span className="website_name">larcity.com</span>, because by using
          the Website you accept and agree to be bound and abide by these Terms
          and Conditions.
        </p>
        ...
        <p>
          ...
          <span className="website_name">larcity.com</span>.
        </p>
        ...
        <p>
          Your use of
          <span className="website_name">larcity.com</span> is at your sole
          risk. The Website is provided "as is" and "as available". We disclaim
        ...
        <p>
          <span className="website_name">larcity.com</span> reserves the right
          to terminate this Terms and Conditions or suspend your account at any
          time in case of unauthorized, or suspected unauthorized use of the
          Website whether in contravention of this Terms and Conditions or
          otherwise. If <span className="website_name">larcity.com</span>{' '}
          terminates this Terms and Conditions, or suspends your account for any
          of the reasons set out in this section,{' '}
          <span className="website_name">larcity.com</span> shall have no
        ...
        <p>
          <span className="website_name">larcity.com</span> may assign this
          Terms and Conditions or any part of it without restrictions. You may
          not assign this Terms and Conditions or any part of it to any third
          party.
        </p>
