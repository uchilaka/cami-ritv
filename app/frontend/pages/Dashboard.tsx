  ...
  return (
    <div className="bg-white">
      <div className="relative isolate mt-16 px-6 pt-14 lg:px-8">
        ...
        <div className="my-3">
          This is a minimal installation of{" "}
          <a
        ...
        <div className="my-3">
          Feel free to fork this and use it for your next spike, mvp, or entire
          application. If you'd like to take a look around to see how everything
          is working, I'd recommend checking out the following files:
          <ul className="m-4 list-disc">
            <li>
              <pre className="inline bg-slate-100">
            ...
            <li>
              ...
              : The React component providing the "magic" layout similar to
              Rails's application layout
            </li>
            <li>
              <pre className="inline bg-slate-100">
