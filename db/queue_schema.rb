...
ActiveRecord::Schema[8.0].define(version: 20_251_211_203_859) do
  ...
  create_enum 'invoice_status',
              %w[draft sent scheduled unpaid cancelled payment_pending marked_as_paid partially_paid paid
                 marked_as_refunded partially_refunded refunded]
  ...
  create_table 'accounts_metadata', id: false, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[account_id metadatum_id], name: 'index_accounts_metadata_on_account_id_and_metadatum_id', unique: true
  end
  ...
  create_table 'accounts_users', id: false, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[account_id user_id], name: 'index_accounts_users_on_account_id_and_user_id', unique: true
  end
  ...
  create_table 'generic_events', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.string 'slug'
    t.index %w[eventable_type eventable_id], name: 'index_generic_events_on_eventable'
  ...
  create_table 'identity_provider_profiles', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[email provider], name: 'index_identity_provider_profiles_on_email_and_provider', unique: true
    t.index %w[uid provider], name: 'index_identity_provider_profiles_on_uid_and_provider', unique: true
    t.index %w[user_id provider], name: 'index_identity_provider_profiles_on_user_id_and_provider', unique: true
  ...
  create_table 'invoices', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[invoiceable_type invoiceable_id], name: 'index_invoices_on_invoiceable'
    t.index %w[invoiceable_type invoiceable_id], name: 'index_invoices_on_invoiceable_type_and_invoiceable_id'
  end
  ...
  create_table 'metadata', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[appendable_type appendable_id], name: 'index_metadata_on_appendable'
  end
  ...
  create_table 'webhooks', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[slug dataset], name: 'index_webhooks_on_slug_and_dataset', where: '(dataset IS NOT NULL)'
