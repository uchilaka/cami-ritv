...
Devise.setup do |config|
  ...
  # config.secret_key = '6d299c8fce85444eeafb7e3b519e28e69f61a63a3a05c8d0b050936f099bc585cff436add8d85de74447a6ee42595652154312c6a00006b89856653ae4c7ac25'
  ...
  # config.pepper = 'f8f6d6c03f4ce1ff1d0b4fc878852c788f7fa416123f4b06766224fd03b50e2e7ff1ba3d5d81c7a4bdbf5471607ecbe2222586944f72e9911e547023c5637733'
  ...
  if AppUtils.omniauth_enabled?
    client_id = ENV['OMNIAUTH_GOOGLE_CLIENT_ID'].presence || Rails.application.credentials.google&.client_id
    client_secret = ENV['OMNIAUTH_GOOGLE_CLIENT_SECRET'].presence || Rails.application.credentials.google&.client_secret
  ...
  config.jwt do |jwt|
    jwt.secret = AppUtils.devise_jwt_secret_key!
