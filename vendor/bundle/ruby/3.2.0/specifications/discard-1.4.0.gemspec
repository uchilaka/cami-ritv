...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, [">= 4.2".freeze, "< 9.0".freeze])
  s.add_development_dependency(%q<bundler>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rake>.freeze, [">= 10.0".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.5.0".freeze])
  s.add_development_dependency(%q<database_cleaner>.freeze, ["~> 1.5".freeze])
  s.add_development_dependency(%q<with_model>.freeze, ["~> 2.0".freeze])
