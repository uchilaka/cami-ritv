...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activemodel>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<activerecord>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<activejob>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<actioncable>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<activestorage>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<actiontext>.freeze, ["= 8.0.2".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, ["= 8.0.2".freeze])
